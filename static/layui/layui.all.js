		...
		var s = {
		 ...
		 f.remove(),s.autoLeft = function() {
			...
			s.where[0]() : 4 === c && o[0] + 16 - s.left > 0 && s.where[1](), a.find("." + l[5]).css({
				...
				left: parseInt(s.tipLeft - (t.fixed ? n.scrollLeft() : 0))+8,
				top: s.tipTop - (t.fixed ? n.scrollTop() : 0)-25
			})
	}, s.pt.move = function() {
		var e = this,
			t = e.config,
			...
			d = {
				select: function() {
					var e, i = "请选择",
						...
						f = u.find("select"),
						v = function(i, l) {
							t(i.target).parent().hasClass(n) && !l || (t("." + a).removeClass(a + "ed " + a + "up"), e && d && e.val()),
								e = null
						},
						y = function(i, u, f) {
							var y, p = t(this),
							...
							if (!u) {
								var C = function() {
									...
									w = function(e) {										i.removeClass(a + "ed " + a + "up"), k.blur(), y = null, e || T(k.val(), function(e) {
